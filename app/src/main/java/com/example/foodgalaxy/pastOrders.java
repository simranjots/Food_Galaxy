...
import com.example.foodgalaxy.ViewHolder.pastOrdersAdapter;
        ...
        orders.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()){
                    ...
                    recyclerView = findViewById(R.id.adminPastOrdersRecycler);
                    pastOrdersAdapter rcdp = new pastOrdersAdapter(orderList, pastOrders.this);
                    recyclerView.setHasFixedSize(true);
                    recyclerView.setLayoutManager(new LinearLayoutManager(pastOrders.this));
